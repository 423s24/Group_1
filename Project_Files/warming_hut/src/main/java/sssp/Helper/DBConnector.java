...
//         Map<String, Map<String, Map<String, Map<String, Map<String, Map<String, Map<String, String>>>>>>> data = gson.fromJson(json, type);

//         Database database = new Database();

//         database.conflicts = data.get("clients").get(this.client).get("Tables").get("Conflicts");
//         database.cubeStorage = data.get("clients").get(this.client).get("Tables").get("CubeStorage");
//         database.dayStorage = data.get("clients").get(this.client).get("Tables").get("DayStorage");
//         //database.equipment = (Map<String, Map<String, String>>) data.get("clients").get(this.client).get("Tables").get("Equipment");
//         database.guestRoster = data.get("clients").get(this.client).get("Tables").get("GuestRoster");
//         //database.guests = (Map<String, Map<String, String>>) data.get("clients").get(this.client).get("Tables").get("Guests");
//         database.lockers = data.get("clients").get(this.client).get("Tables").get("Lockers");
